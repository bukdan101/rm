...
const defaultBanners: Banner[] = [
  { id: '1', title: 'Marketplace Top Banner', imageUrl: 'https://picsum.photos/seed/mp-top/800/150', targetUrl: '/marketplace', position: 'marketplace-top', status: 'active', impressions: 12500, clicks: 450, budgetTotal: 1000000, budgetSpent: 350000, startsAt: new Date().toISOString(), endsAt: null, createdAt: new Date().toISOString() },
  { id: '2', title: 'Marketplace Inline Banner', imageUrl: 'https://picsum.photos/seed/mp-inline/800/150', targetUrl: '/marketplace', position: 'marketplace-inline', status: 'active', impressions: 8900, clicks: 320, budgetTotal: 800000, budgetSpent: 280000, startsAt: new Date().toISOString(), endsAt: null, createdAt: new Date().toISOString() },
  { id: '3', title: 'Marketplace Sidebar', imageUrl: 'https://picsum.photos/seed/mp-side/400/150', targetUrl: '/marketplace', position: 'marketplace-sidebar', status: 'active', impressions: 5600, clicks: 180, budgetTotal: 500000, budgetSpent: 150000, startsAt: new Date().toISOString(), endsAt: null, createdAt: new Date().toISOString() },
  { id: '4', title: 'Home Center Banner', imageUrl: 'https://picsum.photos/seed/home-center/800/150', targetUrl: '/', position: 'home-center', status: 'active', impressions: 15000, clicks: 580, budgetTotal: 1500000, budgetSpent: 520000, startsAt: new Date().toISOString(), endsAt: null, createdAt: new Date().toISOString() },
  { id: '5', title: 'Home Inline Banner', imageUrl: 'https://picsum.photos/seed/home-inline/800/150', targetUrl: '/', position: 'home-inline', status: 'pending', impressions: 0, clicks: 0, budgetTotal: 1000000, budgetSpent: 0, startsAt: new Date().toISOString(), endsAt: null, createdAt: new Date().toISOString() },
]
...
export default function AdminBanners() {
  ...
  async function initializeDefaultBanners() {
    try {
      setLoading(true)
      const newBanners = Object.keys(POSITION_CONFIG).map((position, index) => {
      ...
      toast({
        title: 'Berhasil',
        description: `${newBanners.length} banner default berhasil dibuat.`,
      })
    } catch (error) {
    ...
    try {
      ...
      if (editing) {
        setBanners(prev => prev.map(b =>
          b.id === editing.id
            ? { ...b, ...form, endsAt: form.endsAt || null }
            : b
        ))
      } else {
  ...
  const handleDelete = async () => {
    ...
    try {
      setProcessing(true)
      setBanners(prev => prev.filter(b => b.id !== deleteDialog.banner!.id))
      toast({
        title: 'Berhasil',
    ...
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between">
        ...
        <div className="flex gap-2">
          ...
          <Button onClick={openCreate} className="gap-2 bg-gradient-to-r from-rose-500 to-pink-600 hover:from-rose-600 hover:to-pink-700">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-4">
        <Card className="border-l-4 border-l-rose-500 bg-gradient-to-br from-rose-50 to-white dark:from-rose-950/20 dark:to-background">
          ...
          <CardContent>
            <div className="text-3xl font-bold text-rose-700 dark:text-rose-400">{stats.total}</div>
          ...
          {loading ? (
            ...
            <div className="py-12 text-center text-muted-foreground">
              ...
              <p className="text-sm mt-1 mb-4">
                Klik "Generate Semua Banner" untuk membuat banner default untuk semua posisi.
              </p>
              <Button 
                onClick={initializeDefaultBanners} 
