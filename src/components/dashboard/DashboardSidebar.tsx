...
const mainNavItems = [
  ...
  { title: 'AI Prediction', url: '/dashboard/prediction', icon: Sparkles },
  ...
  { title: 'Favorit', url: '/dashboard/favorites', icon: Heart },
]
...
const otherNavItems = [
  { title: 'Dealer Marketplace', url: '/dashboard/dealer-marketplace-workflow', icon: Store },
...
const quickLinks = [
  ...
  { title: 'Marketplace', url: '/?tab=marketplace', icon: ShoppingBag },
  { title: 'Beli Token', url: '/tokens', icon: Coins },
]
          ...
          <SidebarGroupContent>
            <div className="px-2 py-3">
              <Button
                ...
                className="w-full justify-start gap-2 shadow-sm bg-gradient-to-r from-blue-600 via-purple-600 to-purple-700 hover:from-blue-700 hover:via-purple-700 hover:to-purple-800"
                size={isCollapsed ? 'icon' : 'default'}
              >
                <Plus className="h-4 w-4" />
                {!isCollapsed && <span>Jual Mobil</span>}
              </Button>
            </div>
          </SidebarGroupContent>
        </SidebarGroup>
                ...
                <SidebarMenuItem key={item.title}>
                  ...
                  >
                    ...
                    >
                      ...
                      {item.badge && item.title === 'Pesan' && unreadMessages > 0 && !isCollapsed && (
