...
const buttonVariants = cva(
  "inline-flex items-center justify-center gap-2 whitespace-nowrap text-sm font-medium transition-all duration-300 ease-out disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg:not([class*='size-'])]:size-4 shrink-0 [&_svg]:shrink-0 outline-none focus-visible:border-ring focus-visible:ring-ring/50 focus-visible:ring-[3px] aria-invalid:ring-destructive/20 dark:aria-invalid:ring-destructive/40 aria-invalid:border-destructive",
  {
    variants: {
      variant: {
        // Premium gradient - main brand style
        default:
        ...
        // Success gradient
        success:
          "rounded-full bg-gradient-to-r from-emerald-500 via-green-500 to-teal-500 text-white font-semibold shadow-[0_4px_14px_0_rgba(16,185,129,0.5)] hover:shadow-[0_8px_25px_rgba(16,185,129,0.7)] hover:scale-[1.05] hover:-translate-y-0.5 active:scale-[0.98]",
        // Warning gradient
        warning:
          "rounded-full bg-gradient-to-r from-amber-500 via-orange-500 to-red-500 text-white font-semibold shadow-[0_4px_14px_0_rgba(245,158,11,0.5)] hover:shadow-[0_8px_25px_rgba(245,158,11,0.7)] hover:scale-[1.05] hover:-translate-y-0.5 active:scale-[0.98]",
        // Info gradient
        info:
          "rounded-full bg-gradient-to-r from-cyan-500 via-blue-500 to-indigo-500 text-white font-semibold shadow-[0_4px_14px_0_rgba(59,130,246,0.5)] hover:shadow-[0_8px_25px_rgba(59,130,246,0.7)] hover:scale-[1.05] hover:-translate-y-0.5 active:scale-[0.98]",
        // Rose gradient
        rose:
          "rounded-full bg-gradient-to-r from-rose-500 via-pink-500 to-fuchsia-500 text-white font-semibold shadow-[0_4px_14px_0_rgba(244,63,94,0.5)] hover:shadow-[0_8px_25px_rgba(244,63,94,0.7)] hover:scale-[1.05] hover:-translate-y-0.5 active:scale-[0.98]",
      },
      size: {
